...
class QdbQueryEffectsTest extends QdbTestBase
{
    ...
    public function testFillTable()
    {
        try {
            ...
            $this->assertEquals($query->rows()[0][2]->type(), QdbQueryPoint::STRING);
            ...
            $this->assertEquals($query->rows()[1][2]->type(), QdbQueryPoint::STRING);
    ...
    public function testNullValues()
    {
        try {
            ...
            $this->assertEquals($query->rows()[0][1]->value(), null);
            ...
            $this->assertEquals($query->rows()[1][1]->value(), 'Alice');
            $this->assertEquals($query->rows()[1][2]->value(), null);

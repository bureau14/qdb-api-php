...
class QdbQueryEffectsTest extends QdbTestBase
{
    ...
    {
        try {
            checkEmptyQuery('CREATE TABLE persons(name BLOB, age INT64)');
            checkEmptyQuery('INSERT INTO  persons($timestamp, name, age) VALUES'.
    ...
    {
        checkEmptyQuery('CREATE TABLE flavours(blob BLOB, int64 INT64, ts TIMESTAMP, f64 DOUBLE)');
        checkEmptyQuery('INSERT INTO  flavours($timestamp, blob, int64, ts, f64) VALUES'.

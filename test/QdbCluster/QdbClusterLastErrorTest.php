...
class QdbClusterLastErrorTest extends QdbTestBase
{
    public function testErrors()
    {
        ...
        $this->assertEquals($err1->error(), hexdec('B1000008')); // Code for qdb_e_alias_not_found.
        $this->assertEquals($err1->message(), 'at qdb_remove: Could not find alias.');

        $this->assertEquals($err2->error(), hexdec('B1000009')); // Code for qdb_e_alias_already_exists.
